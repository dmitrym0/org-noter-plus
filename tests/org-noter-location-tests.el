                              ...
                              (it "can parse a page location"
                                  (with-mock-contents
                                   ...
                                   '(lambda ()
                                      ...
                                      (expect (org-noter--parse-location-property (org-noter--get-containing-element)) :to-equal (read "(699 . 0.123031)"))
                                      )
                    ...
                    (it "goto-location-hook works"
                        (with-mock-contents
                         ...
                         '(lambda ()
                            ...
                            (expect 'org-noter-location-test-goto-location :to-have-been-called-with "pubs/solove-nothing-to-hide.pdf"  (read "(699 . 0.123031)") _test_window)
                            )
                         ))
                    )
          )
